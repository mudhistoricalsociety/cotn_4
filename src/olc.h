...
void add_reset args((ROOM_INDEX_DATA * room, RESET_DATA * pReset, int id));
...
DECLARE_OLC_FUN(redit_shoptype);
DECLARE_OLC_FUN(redit_shopitem);
...
DECLARE_OLC_FUN(oedit_msg1);
DECLARE_OLC_FUN(oedit_msg2);
